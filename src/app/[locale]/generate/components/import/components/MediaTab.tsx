...
import { setFiles, setImportMethod } from '@/app/[locale]/generate/stores/features/importDialogSlice';
...
const MediaTab: React.FC = () => {
    ...
    if (isDevelopment) {
        return (
            <div className="text-center text-gray-500 min-h-[200px] flex flex-col items-center justify-center">
