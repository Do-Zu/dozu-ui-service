...
import ankiSettingUtil from '../../../../settings/anki/utils/ankiSetting.util';
import CreateSettingModal from '../../../../settings/anki/components/CreateSettingModal';
...
import UpdateSettingModal, { IUpdatingSetting } from '../../../../settings/anki/components/UpdateSettingModal';
import { DeleteSettingModal, IDeletingSetting } from '../../../../settings/anki/components/DeleteSettingModal';
import { DEFAULT_ANKI_SETTING } from '@/services/anki-setting/constant';
import ResetToDefaultModal from '../../../../settings/anki/components/ResetToDefaultModal';
import { ITopic } from '@/app/[locale]/topics/types/topic.type';
import { useRequireTopic } from '../../../context/useRequireTopic';
import { useRequireAnkiSettings } from '../../../context/useRequireFlashcardContent';
...
function FlashcardSettings() {
    ...
    const { topicId } = topic;
    const { ankiSettings, setAnkiSettings } = useRequireAnkiSettings();
