      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="flex items-center gap-6 mb-4">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold flex items-center gap-2">
                <span className={correctCount === totalQuestions ? 'text-green-600 dark:text-green-400' : 'text-foreground'}>
          ...
          <div className="flex gap-2">
            <Button 
              variant="outline" 
              onClick={() => router.push(`/class-based/${classId}/class-quiz/${classQuizId}/start`)}
            >
              Back to Quiz
            </Button>
          </div>
