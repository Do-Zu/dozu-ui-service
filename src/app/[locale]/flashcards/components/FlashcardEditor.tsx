...
interface BaseProps {
  handleOnClickSave: (flashcards: IFlashcardWithServer[]) => void
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-row gap-4 items-center">
          ...
          <div className="text-[#1F2937] text-[1.7rem] font-bold">
            {type === 'manual' ? flashcardsProp.topicName : 'Flashcards Generated'}
          </div>
        </div>
        <div className="flex flex-row gap-4">
          ...
          {shouldShowSaveButton ? (
            <Button onClick={() => handleOnClickSave(flashcards)} className="flex flex-row items-center">
              <Save size={24} />
