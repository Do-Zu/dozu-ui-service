...
import { PresignedUrlRequest, PresignedUrlResponse } from './upload.service';
...
export const uploadApi = {
  ...
  requestPresignedUrl: async (params: {
    ...
    const response = await postRequest<PresignedUrlRequest, PresignedUrlResponse>(
  ...
  notifyUploadComplete: async (params: {
    ...
    return await postRequest('/upload/complete', params);
  },
